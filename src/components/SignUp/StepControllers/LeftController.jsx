...
export function LeftController() {
    ...
    return (
        <button onClick={handleGoStepBack}>    
            <svg 
                className={ checkAbilityToGoBack() ? 'absolute top-[95%] md:top-1/2 left-[5%] md:left-[unset] right-full scale-150 md:mr-4 h-5 w-5 text-slate-600 font-thin leading-5 rotate-90 hover:cursor-pointer' : 'absolute top-[95%] md:top-1/2 left-[5%] md:left-[unset] md:right-full scale-150 md:mr-4 h-5 w-5 text-slate-400 opacity-70 font-thin leading-5 rotate-90 hover:cursor-pointer' } 
            >
